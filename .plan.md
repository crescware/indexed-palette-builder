...
### 3. Create Color Format Context

**Directory**: `src/contexts/color-format/`
...
### 5. Create Format Selector Component
...
### 7. Update Settings Reset (Optional)
...
| `src/components/color-format-select.tsx` | Dropdown selector component |
...
| `src/components/header.tsx` | Add `ColorFormatSelect` component |
